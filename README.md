...
#### News Data Processing (New!)
- Bulk news data collection and analysis
- Sentiment extraction and event detection
- Integration with price data for combined signals
- Natural language processing for market-moving events

#### Macro Data Processing (New!)
- Economic indicators collection and normalization
- Interest rate environment analysis
- Market regime detection
- Correlation with individual securities

#### SEC Filings Analysis (New!)
- 10-K and 10-Q filings collection and processing
...
- Interactive Brokers integration with **ib_async** (updated!)
...
- Complete Interactive Brokers integration (backtrader/ib_async)
...
- Multi-core CPU for parallel processing (45mins at 32 cores 5.15GHz not including 1.5Hrs for ratelimited OHLCV download each night)
